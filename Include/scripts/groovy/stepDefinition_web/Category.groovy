...
class Category {
	...
	@When("input emailCategory with {string}")
	public void input_emailCategory_with(String emailCategory) {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/User Login/Input Email'), [('email') : GlobalVariable.emailRizki], 
			FailureHandling.STOP_ON_FAILURE)
	}

	@When("input passwordCategory with {string}")
	public void input_passwordCategory_with(String passwordCategory) {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/User Login/Input Password'), [('password') : GlobalVariable.passwordRizki], 
			FailureHandling.STOP_ON_FAILURE)
	}

	@Then("click button masukCategory")
	public void click_button_masukCategory() {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/User Login/Button Masuk'), [:], FailureHandling.STOP_ON_FAILURE)
	}
	
	@Then("click button category")
	public void click_button_category() {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/Homepage - Category/Category - Baju'), [:], FailureHandling.STOP_ON_FAILURE)
	}
