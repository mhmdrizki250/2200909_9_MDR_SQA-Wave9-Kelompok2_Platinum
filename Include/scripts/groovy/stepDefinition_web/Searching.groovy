...
class Searching {
	...
	@When("input emailSearching with {string}")
	public void input_emailSearching_with(String emailSearching) {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/User Login/Input Email'), [('email') : GlobalVariable.emailRizki],
		FailureHandling.STOP_ON_FAILURE)
	}

	@When("input passwordSearching with {string}")
	public void input_passwordSearching_with(String passwordSearching) {
	...
	public void click_button_masukSearching() {
	...
	public void click_button_searching() {
		WebUI.callTestCase(findTestCase('secondhand-web/Pages/Homepage - Searching/Input Search - Enter'), [:], FailureHandling.STOP_ON_FAILURE)
	}
