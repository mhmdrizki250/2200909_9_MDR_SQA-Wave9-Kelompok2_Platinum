...
WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Harga Produk'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Select Kategori'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Lokasi'), [:], FailureHandling.STOP_ON_FAILURE)
