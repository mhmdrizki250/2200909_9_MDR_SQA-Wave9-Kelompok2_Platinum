...
WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Nama Produk - Blank'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Harga Produk - Blank'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Select Kategori - Blank'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Lokasi - Blank'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Input Deskripsi - Blank'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-app/Pages/Add Product/Tap Foto Produk - Blank'), [:], FailureHandling.STOP_ON_FAILURE)
