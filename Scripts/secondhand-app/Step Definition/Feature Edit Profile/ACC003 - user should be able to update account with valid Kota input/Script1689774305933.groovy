...
WebUI.callTestCase(findTestCase('secondhand-app/Pages/Edit Profile/Edit City'), [('city') : GlobalVariable.AsiyahEmailSellercityOkta], FailureHandling.STOP_ON_FAILURE)
