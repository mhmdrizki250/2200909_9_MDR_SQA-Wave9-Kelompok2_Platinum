...
WebUI.callTestCase(findTestCase('secondhand-app/Pages/Price Negotiation/Input atasan wanita'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('secondhand-app/Pages/Price Negotiation/Input harga'), [:], FailureHandling.STOP_ON_FAILURE)
