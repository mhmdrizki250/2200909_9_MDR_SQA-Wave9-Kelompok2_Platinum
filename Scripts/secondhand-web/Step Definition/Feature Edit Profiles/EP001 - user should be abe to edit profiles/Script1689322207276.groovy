...
WebUI.callTestCase(findTestCase('secondhand-web/Pages/My Profiles/Input Nama'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/My Profiles/Select Kota'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/My Profiles/Input Alamat'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/My Profiles/Input Nomor HP'), [:], FailureHandling.STOP_ON_FAILURE)
