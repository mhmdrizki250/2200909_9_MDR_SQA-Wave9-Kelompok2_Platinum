...
WebUI.callTestCase(findTestCase('secondhand-web/Pages/Notification/Notification Message'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/Notification/Detail Notification'), [:], FailureHandling.STOP_ON_FAILURE)
