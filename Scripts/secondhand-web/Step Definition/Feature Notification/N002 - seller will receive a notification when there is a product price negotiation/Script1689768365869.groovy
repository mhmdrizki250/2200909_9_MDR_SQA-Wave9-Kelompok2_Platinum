...
WebUI.callTestCase(findTestCase('secondhand-web/Pages/User Login/Input Email'), [('email') : GlobalVariable.AsiyahEmailSeller], 
...
WebUI.callTestCase(findTestCase('secondhand-web/Pages/Notification/Notification Icon'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/Notification/Seller - Message Notification'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('secondhand-web/Pages/Notification/Seller - Detail Message'), [:], FailureHandling.STOP_ON_FAILURE)
